...
create index diagnostic_evidence_case_id_idx on diagnostic_evidence (case_id);
create index diagnostic_evidence_type_idx on diagnostic_evidence (case_id, evidence_type);
...
create unique index diagnostic_graph_case_id_idx on diagnostic_graph (case_id);
...
create index diagnostic_questions_case_id_idx on diagnostic_questions (case_id, sequence);
...
create unique index diagnostic_answers_question_id_idx on diagnostic_answers (question_id);
create index diagnostic_answers_case_id_idx on diagnostic_answers (case_id);
...
create table diagnostic_probabilities (
  id uuid primary key default gen_random_uuid(),
  case_id uuid not null references scan_cases (id) on delete cascade,
...
create index diagnostic_probabilities_case_id_idx on diagnostic_probabilities (case_id, rank);
...
create index repair_verifications_case_id_idx on repair_verifications (case_id);
