...
export default async function RepairPdfsPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-16">
      <h1 className="text-3xl font-bold text-white">Repair PDFs</h1>
      <p className="mt-2 text-zinc-400">
        Master Diagnostic PDF guides with wiring checks, scan tool data, and repair direction.
      </p>
      ...
      <div className="mt-10 rounded-2xl border border-red-500/30 bg-gradient-to-br from-red-600/10 to-transparent p-8 text-center backdrop-blur-md">
        <h2 className="text-xl font-bold text-white">Master Diagnostic PDF</h2>
        <p className="mt-2 text-sm text-zinc-300">
          The complete professional repair workflow, covering wiring checks, scan
