...
import { DEFAULT_LOCALE, isRecognizedLocaleCode, isLiveLocale } from "@/lib/i18n/locale-codes";
...
export default getRequestConfig(async ({ requestLocale }) => {
  ...
  // Only built (LIVE_LOCALES) locales have a real message catalog — every
  // other recognized locale code falls back to English messages rather than
  // a 404 or a build-time import error, since the registry intentionally
  // holds locales that aren't translated yet.
